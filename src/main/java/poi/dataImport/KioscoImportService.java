...
public class KioscoImportService extends DataImportService {
	...
	TimeRange rangoSuperiorDeLaSemana = new TimeRange(LocalTime.of(17,0,0),LocalTime.of(23,30,0));
	...
	void processData(JSONObject responseJson) throws JSONException {
		try {
	    	...
	    	LocalComercial libreria = new LocalComercial(name, posicion, direccion, RadioCercania.Kiosco);
